...
set_keymap("n", "<A-p>", "<CMD>tabnext<CR>", { desc = "Previous tab" })
-- set_keymap("n", "<leader>j", "<CMD>tabprevious<CR>", { desc = "Previous tab" })
set_keymap("n", "<A-n>", "<CMD>tabprevious<CR>", { desc = "Next tab" })
...
set_keymap("t", "<A-n>", "<CMD>tabprevious<CR>", { noremap = true, desc = "<CMD>tabprevious<CR>" })
