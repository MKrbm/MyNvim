...
set_keymap("n", "<A-j>", "<CMD>tabprevious<CR>", { desc = "Next tab" })
...
set_keymap("n", "<S-A-k>", "<cmd>m .+1<cr>==", { desc = "Move down" })
set_keymap("n", "<S-A-j>", "<cmd>m .-2<cr>==", { desc = "Move up" })
...
-- set_keymap("i", "<A-k>", "<Down>", { desc = "Move cursor down" })
...
set_keymap("i", "<A-k>", "<C-p>", { desc = "Naitive autocmp" })
set_keymap("i", "<A-j>", "<C-n>", { desc = "Naitive autocmp" })
...
-- set_keymap("n", "<A-k>", ":lua require('dapui').eval()<CR>", { desc = "DapUiEval" })
