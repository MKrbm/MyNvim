...
return {"nvim-lua/plenary.nvim", {
  ...
  lazy = false,
  dependencies = {"mfussenegger/nvim-dap-python", "rcarriga/nvim-dap-ui", "jay-babu/mason-nvim-dap.nvim"},
  ...
  dependencies = {{"drybalka/tree-climber.nvim"}, {"mfussenegger/nvim-treehopper"}, {
    "HiPhish/rainbow-delimiters.nvim",
    config = function()
      require("rainbow-delimiters.setup").setup({
        highlight = {"rainbow1", "rainbow2", "rainbow3", "rainbow4", "rainbow5", "rainbow6", "rainbow7"}
      })
    end
  } -- {
  ...
  dependencies = {{"nvim-treesitter/nvim-treesitter"}, {
    ...
    lazy = true,
    cmd = {"SessionToggle", "SessionStart", "SessionStop", "SessionSave", "SessionLoad", "SessionLoadLast",
  ...
  lazy = true,
  cmd = {"CMakeBuild", "CMakeClean", "CMakeConfigure", "CMakeInstall", "CMakeTest", "CMakeToggle", "CMakeRun",
         "CMakeOpen", "CMakeGenerate", "CMakeDebug", "CMakeStop", "CMakeQuickDebug"},
  config = function()
